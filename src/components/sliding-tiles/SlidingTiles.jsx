...
export default function SlidingTiles() {
  ...
  return (
    <div className="relative h-[300vh] 1280px:h-[600vh]" ref={targetRef}>
      <div className="sticky top-0 h-screen">
        ...
        <section className="sliding-tiles h-[100vh] hidden 1280px:flex relative px-[40px] items-center justify-between 1280px:justify-center 600px:py-[60px] 600px:px-[16px]">
          <motion.div
